...
$(document).ready(function () {
    ...
    //     //    exit();
    //     $.ajax({
    //         url: '/setting_default/edit-branch/' + Branch_id,
    //         type: "GET",
    //         dataType: 'json',
    //         success: function (res) {
    //             // let $data = res.data
    //             $('#modalEditBranch').modal('show');
    //             $('#updateBranch #BranchId').val(res.data.id);
    //             $('#updateBranch #editBranch').val(res.data.branch_name);
    //         },
    //         error: function (data) { }
    //     });
    // });
    ...
    // //modalUpdateBranch
    // let $modalEditBranch = $("#modalEditBranch")
    ...
    //         // เช็คข้อมูล
    //         if ($formEditBranch.find('input[name=editBranch]').val() == '') {
    ...
    //             $.ajax({
    //                 type: "POST",
    //                 url: '/setting_default/update-branch',
    //                 data: formData,
    //                 processData: false,
    //                 contentType: false,
    //             }).done(function (res) {
    ...
    //                         if (result.isConfirmed) {
    //                             setTimeout(function () {
    //                                 window.location = '/setting_default/branch'
    //                             }, 1 * 1500)
    //                         }
    //                     })
    ...
    //         if (result.isConfirmed) {
    //             $.ajax({
    //                 url: '/setting_default/delete-branch/' + Branch_id,
    //                 method: 'get',
