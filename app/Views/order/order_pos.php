                                                                ...
                                                                <div class="white_card_header">
                                                                    <div id="order_select_detail">
                                                                        ...
                                                                        <div class="devices_btn justify-content-start">
                                                                            <a class="btn btn-outline-primary mb-2" style="margin-right: 9px; line-height:1.3;" id="addOrderCusBtn" href="javascript:void(0);" onclick="openAddOrder_customer();"><i class="ti-plus"></i> Add</a>
                                                                            <a class="btn btn-outline-secondary mb-2" style="margin-right: 9px; line-height:1.3;" id="move_order_btn" href="javascript:void(0);" onclick="open_move_order_();"><i class="ti-new-window"></i> Move</a>
                                                                            <a class="btn btn-outline-secondary mb-2" style="margin-right: 9px; line-height:1.3;" id="discount_order_btn" href="javascript:void(0);" onclick="openModaldiscountAllType_();"><i class="fas fa-hryvnia"></i> Discount</a>
