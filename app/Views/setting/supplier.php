                    ...
                    <?php if ($suppliers) : ?>
                      ...
                      <?php foreach ($suppliers as $supplier) : ?>
                        ...
                        <tr id="<?php echo $supplier->id; ?>">
                          ...
                          <td> <?php echo datetime_compare($supplier->created_at); ?></td>
...
<!-- Model Add Product -->
<div class="modal fade bd-add-supplier" tabindex="-1" role="dialog" aria-labelledby="productModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
