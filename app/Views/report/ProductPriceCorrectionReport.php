<div class="main_content_iner overly_inner ">
    <div class="container-fluid p-0 ">
        ...
        <div class="row ">
                                ...
                                <div class="row mb-3">
                                    <div class=" col-md-4">
                                        <select id="query-type" class="form-control">
                                            ...
                                            <option value="ProductPriceCorrectionReport" selected>รายงานแก้ราคาสินค้า </option>
            ...
            <div id="vue-report-setprice-container" class="row " style="display: block;">
                <div class="col-md-3">
                            ...
                            <form role="form" class="form-horizontal">
                                <div class="form-body">
                                    <div class="form-group"><label class="col-md-5 control-label">เลือกวันที่</label>
                                        <div class="col-md-7">
                                            <div class="input-group"><input id="setPriceStartDate" type="text" placeholder="Date" class="form-control"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span></div>
                                        </div>
                                    </div> <!---->
