...
class CrearteTableTransection extends Migration
{
    public function up()
    {
        ...
        $sql_stock_posx = "CREATE TABLE `stock_transaction` (`id` INT NOT NULL AUTO_INCREMENT , `stock_code` TEXT NULL , `begin` INT NOT NULL DEFAULT 0 , `add` INT NOT NULL DEFAULT 0 , `sold` INT NOT NULL DEFAULT 0 , `adjust` INT NOT NULL DEFAULT 0 , `withdraw` INT NOT NULL DEFAULT 0 , `return` INT NOT NULL DEFAULT 0 , `balance` INT NOT NULL DEFAULT 0  , `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY (`id`), INDEX (`id`), INDEX (`stock_code`)) ENGINE = InnoDB";
